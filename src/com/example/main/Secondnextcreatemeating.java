...
/////////////////// *** Start  Variable Declaration *** ///////////////////////////	
	 ...
	 private String[] state = {"Select Evaluator From List", "Evaluator 1", "Evaluator 2","Evaluator 3", " Evaluator 4", "Evaluator 5", "Evaluator 6","Evaluator 7", "Evaluator 8"};
	 		String evaluator;
	 		Spinner spinnerevaluator;
	 private String[] state1 = { "Select Speaker From List","Speaker 1", "Speaker 2","Speaker 3", " Speaker 4"};
	 		String speaker;
...
/////////////////// Close Initialization Widgets  ///////////////////////////
			...
			adapter_state.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);  // ArrayAdapter_state
			spinnerevaluator.setAdapter(adapter_state);           // set ArrayAdapter_state
			spinnerevaluator.setOnItemSelectedListener(this);

			ArrayAdapter<String> adapter_state1 = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item, state1);  // ArrayAdapter_state1
			adapter_state.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
			spinnerspeaker.setAdapter(adapter_state1);           // set ArrayAdapter_state1
			 ...
			 private void Save_Profile() {
				 			...
				 			new Thread() {
											@Override
												...
												String postURL = ("http://132connect.com/club/server/meeting.php");
												HttpPost post = new HttpPost(postURL);
				    	    try {
				    	    					String[] c = new String[] {themee,worrk,timee,mastr,evaluatr,timr,ahconter,gramarrn,speaker,evaluator};
				             ...
				             runOnUiThread(new Runnable() {
								    public void run() {
								    	...
								    	if(status1.equals("SUCCESS")){
								    		 Intent i= new Intent(Secondnextcreatemeating.this,Login.class);
											 startActivity(i); 
											 finish();
								    	}
								    }
...
/////////////////// *** Close Save_Profile Method *** ///////////////////////////
	...
	@Override
	public void onItemSelected(AdapterView<?> parent, View view, int position,long id)   //ItemSelected
	{
