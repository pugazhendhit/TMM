...
/////////////////// Start OnClick Method  ///////////////////////////
		...
		public void onClick(View arg0) {
				Save_Profile();    //call Save_Profile() method
			}
			});
		 ...
		 private void Save_Profile() {
			 					...
			 					new Thread() {
								   ...
								   public void run() {
											...
											String postURL = ("http://132connect.com/club/server/register_club.php");
											HttpPost post = new HttpPost(postURL);
										try {
												String[] c = new String[] { countryy,statee,cityy,club,name,con,pas};
