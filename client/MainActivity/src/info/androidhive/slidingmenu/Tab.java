	      ...
	      ////////////////////// 2 //////////////////////////////////////
	       ...
	       mTabHost.addTab(mTabHost.newTabSpec("grammarian")
		       ...
		       mTabHost.addTab(mTabHost.newTabSpec("counter")
	               ...
	               mTabHost.getTabWidget().getChildAt(0).getLayoutParams().width = 190;
	               mTabHost.getTabWidget().getChildAt(1).getLayoutParams().width = 190;
	               mTabHost.getTabWidget().getChildAt(2).getLayoutParams().width = 190;
	               mTabHost.getTabWidget().getChildAt(3).getLayoutParams().width = 190;
