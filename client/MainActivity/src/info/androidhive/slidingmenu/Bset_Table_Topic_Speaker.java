...
public class Bset_Table_Topic_Speaker extends ListActivity {
	...
	ArrayList<HashMap<String, String>> contactList;
	 ...
	 public void onCreate(Bundle savedInstanceState) {
		  super.onCreate(savedInstanceState);
			...
			setContentView(R.layout.best_table_topic_speaker);
			...
			pDialog = new ProgressDialog(Bset_Table_Topic_Speaker.this);
				...
				new Thread()
			{
				...
				private void Setarray() {
					...
					ListAdapter adapter = new SimpleAdapter(
							Bset_Table_Topic_Speaker.this, contactList,
