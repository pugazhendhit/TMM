...
public class Best_Meeting_Speaker extends ListActivity {
	...
	ArrayList<HashMap<String, String>> contactList;
	 ...
	 public void onCreate(Bundle savedInstanceState) {
		  super.onCreate(savedInstanceState);
			...
			setContentView(R.layout.best_meeting_speaker);
			...
			pDialog = new ProgressDialog(Best_Meeting_Speaker.this);
				...
				new Thread()
			{
				...
				private void Setarray() {
					...
					ListAdapter adapter = new SimpleAdapter(
							Best_Meeting_Speaker.this, contactList,
