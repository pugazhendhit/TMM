...
public class ViewfragmentActivity extends Fragment {
...
/////////////////// *** Start OnCreateMethod *** ///////////////////////////	
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		lv.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			//work = ((TextView) view.findViewById(R.id.mobile))
//						.getText().toString();
			work = ((TextView) view.findViewById(R.id.workk))
				 ...
				 timee = ((TextView) view.findViewById(R.id.email))
						.getText().toString();
//				 iddd = ((TextView) view.findViewById(R.id.name))
//							.getText().toString();
//				// int foo = Integer.parseInt(iddd);
//				 Log.e("id", iddd);
				
				 
				 Intent update =new Intent(getActivity(),Detailclient.class);
