...
/////////////////// *** Start  Variable Declaration *** ///////////////////////////	
	...
	// JSON Node names
	private static final String TAG_CONTACTS = "show_user_reg_status";
...
/////////////////// *** Start OnCreateMethod *** ///////////////////////////	
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		IDD=(preferences.getString("PASS", ""));
...
viewreq.setOnClickListener(new OnClickListener() {
	...
	public void onClick(View arg0) {
		...
		Intent req=new Intent(getApplicationContext(),Viewrequest.class);
		startActivity(req);
	}
});
		...
		new Thread()
	{
		...
		try
			 {        
	                ...
	                httppost1= new HttpPost("http://anythinginfotech.in/Android/club/server/show_user_reg_status.php");
	                nameValuePairs1 = new ArrayList<NameValuePair>();
		           nameValuePairs1.add(new BasicNameValuePair("club_id",IDD));  
...
public void run() 
{
	...
	private void removeenroll() {
		...
		new Thread()
		{
			...
			public void run()
			{
				 try{          Log.e("iggg", emaill);  
					
			            httpclient=new DefaultHttpClient();
			            httppost= new HttpPost("http://anythinginfotech.in/Android/club/server/upd_status_deactive.php");
			            nameValuePairs = new ArrayList<NameValuePair>(1);
			            nameValuePairs.add(new BasicNameValuePair("user_id",emaill));  
